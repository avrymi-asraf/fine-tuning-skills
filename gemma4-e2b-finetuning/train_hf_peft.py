#!/usr/bin/env python3
"""
Fallback training script for Gemma 4 E2B using standard HF TRL + PEFT + QLoRA.
Use this if Unsloth is unavailable or you need more explicit control.
...
def main():
    parser = argparse.ArgumentParser(description="Gemma 4 E2B HF PEFT QLoRA training")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/hf-gemma4-e2b",
